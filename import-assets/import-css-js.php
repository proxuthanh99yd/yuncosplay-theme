...
{
	wp_enqueue_style('font-PhuDu', 'https://fonts.googleapis.com/css2?family=Phudu:wght@300..900&display=swap', [], THEME_VERSION);
...
function  wp_enqueue_local()
{
	$wp_enqueue_mapping = [
		...
		[
			'type' => 'style',
			'handle' => 'cta',
			'src' => get_theme_file_uri('/template-parts/layouts/cta/assets/styles.css'),
			'deps' => [],
			'ver' => THEME_VERSION,
			'in_footer' => false,
			'condition' => true
		...
		[
			'type' => 'script',
			'handle' => 'cta',
			'src' => get_theme_file_uri('/template-parts/layouts/cta/assets/scripts.js'),
			'deps' => [],
			'ver' => THEME_VERSION,
			'in_footer' => true,
			'condition' => true
		...
		[
			'type' => 'style',
			'handle' => 'components',
			'src' => get_theme_file_uri('/template-parts/components/assets/styles.css'),
			'deps' => [],
			'ver' => THEME_VERSION,
			'in_footer' => false,
			'condition' => true
		...
		[
			'type' => 'script',
			'handle' => 'components',
			'src' => get_theme_file_uri('/template-parts/components/assets/scripts.js'),
			'deps' => [],
			'ver' => THEME_VERSION,
			'in_footer' => true,
			'condition' => true
