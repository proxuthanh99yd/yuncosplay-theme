...
export const sectionTravelguideScripts = () => {
  const CONFIG = {
  ...
  const SELECTORS = {
    SWIPER: "#travelguide-swiper",
    SECTION: "#travelguide",
    SLIDES: ".travelguide__swiper .swiper-slide",
    BUTTON_PREV: ".travelguide__button--prev",
    BUTTON_NEXT: ".travelguide__button--next",
  };
