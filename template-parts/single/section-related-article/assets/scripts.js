...
export const sectionArticleScripts = () => {
  const CONFIG = {
  ...
  const SELECTORS = {
    SWIPER: "#related-article-swiper",
    SECTION: "#related-article",
    SLIDES: ".related-article__swiper .swiper-slide",
    BUTTON_PREV: ".related-article__button--prev",
    BUTTON_NEXT: ".related-article__button--next",
  };
