...
$_LOCATION_ICON = 63;
$_ARROW_LEFT_ICON = 56;
$_CLOSE_ARROW_ICON = 'https://horizonvietnamtravel.okhub-tech.com/wp-content/uploads/2025/03/menu.svg';
?>

<section id="list-tours" class="list-tours">
    <div class="list-tours__header">
        <div class="heading list-tours__title">
            <h2>Circuits Vietnam sur mesure</h2>
        </div>
        <p class="list-tours__description">
            Agence de voyage locale, nous vous proposons un large éventail de voyages originaux et riches en émotion au
            Vietnam, au
            <br>
            Cambodge, au Laos et en Thailande. Quoi qu’il en soit, toute notre gamme de circuit Vietnam vous
            oriente vers l’authenticité avec
            <br>
            un haut niveau de conseils, sans intermédiaire, et donc pas cher,
            toujours dans le respect des habitants et de leur culture.
        </p>
    </div>
        ...
        <div class="customized-trip__card">
            ...
            <div class="customized-trip__card-content">
                ...
                <p class="customized-trip__card-location">
                    ...
                    <span>Hanoi - Tuan Chau - Lan Ha Bay - Ha Giang</span>
                </p>
