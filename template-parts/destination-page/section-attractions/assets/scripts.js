export function sectionAttractionsScripts() {
    ...
    const btnViewMore = document.querySelector(".destination-attractions_view-more");
    const progressCurrent = document.querySelector(".destination-attractions-progress-current");
    const progressViewed = document.querySelector(".destination-attractions_progress-viewed");
    const cards = Array.from(
        document.querySelectorAll(".destination-attractions_card")
    );
    const btnPopups = document.querySelectorAll(".destination-attractions_card");
