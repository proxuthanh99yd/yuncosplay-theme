...
export function tabBarScripts() {
  ...
  const tabsHeight = tabBar?.clientHeight || 0;
  ...
  const EXTRA_OFFSET = isMobile ? tabsHeight : headerTopHeight;
  ...
  tabs.forEach((tab) => {
    tab.addEventListener("click", () => {
      ...
      if (el) {
        ...
        const y = el.getBoundingClientRect().top + window.scrollY - EXTRA_OFFSET;
