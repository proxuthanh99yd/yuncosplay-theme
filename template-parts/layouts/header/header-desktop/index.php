    ...
    <div class="header__topbar">
        <div class="header__topbar-wrapper">
			<div class="header__topbar-left">
				...
				<a href="<?= $contact_phone['url'] ?>" target="<?= $contact_phone['target'] ?? '_self'; ?>" class="header__phone">
				...
				<a href="<?= $contact_email['url'] ?>" target="<?= $contact_email['target'] ?? '_self'; ?>" class="header__email">
			...
			<div class="header__topbar-right">
				...
				<ul class="header__social-list">
					...
					<li class="header__social-item">
						<a href="<?= $social_link_url ?>" target="<?= $social_link_target ?>" class="header__social-link">
				...
				<a href="<?= $contact_address['url'] ?>" target="<?= $contact_address['target'] ?? '_self'; ?>" class="header__address">
