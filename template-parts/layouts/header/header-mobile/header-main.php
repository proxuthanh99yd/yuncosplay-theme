...
<div class="header-main">
    ...
    <div class="header-main-right">
        <div
            class="header-main__search-input-wrapper"
            data-search-base="<?php echo esc_url(home_url('/')); ?>"
            data-search-post-type="product">
            <input class="header-main__search-input" type="text" name="s" inputmode="search" enterkeyhint="search" autocomplete="off" placeholder="Nhập từ khoá tìm kiếm" />
            <button type="button" class="header-main__search-button">
