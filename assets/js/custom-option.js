...
class CustomDropdown extends HTMLElement {
  ...
         //border-color: var(--dropdown-trigger-hover-border, transparent);
      }
      
      .dropdown-trigger:focus {
        // outline: none;
        // border-color: var(--dropdown-trigger-border-focus, #cce8c6);
        // box-shadow: 0 0 0 1px rgba(49, 130, 206, 0.2);
      }
      
      .dropdown-trigger.open {
        border-color: var(--dropdown-trigger-open-border, transparent);
      ...
      span[slot="placeholder"] {
        ...
        line-height: var(--selected-content-line-height, 160%);
      }
